...
const DIMENSIONS = {
    ...
    MAX_DISTANCE: 300,
    OFFSET_DISTANCE: 8 // Adjust offset for bidirectional edges
};
...
const BFS = () => {
    ...
    const handleStartNodeInput = (e) => {
        ...
        if (newStartNode && adjacencyList[newStartNode]) {
            fetchBFSSteps(adjacencyList, newStartNode);
        } else {
            setSteps([]);
    ...
    const drawGraph = async (graph, newNodes = []) => {
        ...
        // Fetch BFS steps if startNode is valid
        await fetchBFSSteps(graph, startNode);
    };
                                        ...
                                        <div className="card-body p-6">
                                            ...
                                            <div className="mt-4 p-4 bg-info/10 rounded-xl border-l-4 border-info">
                                                <p className="text-sm text-base-content/80 leading-relaxed">
                                                    BFS explores all vertices and edges level by level, using a queue to track nodes, where V is the number of vertices and E is the number of edges.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div className="flex flex-col h-full items-center justify-center p-8 bg-neutral/5 rounded-xl border-2 border-dashed border-base-300">
                                                        <div className="flex flex-col items-center justify-center">
                                                            ...
                                                            <p className="flex-1 text-sm text-base-content/60 text-center">
                                                                Run a BFS traversal to see<br />detailed execution metrics
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div className="px-4 py-3 w-full min-h-[100px] max-h-[400px] overflow-y-auto scrollbar-thin scrollbar-thumb-primary/30 scrollbar-track-base-200">
                            {visited.length === 0 ? (
                                <div className="flex flex-col items-center justify-center py-8 text-base-content/40">
                                    ...
                                    <span className="text-xs text-center">Start traversal<br/>to see queue</span>
                                </div>
                            ) : (
