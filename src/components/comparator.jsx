...
const Comparator = () => {
    ...
    const handleCategorySelect = (event) => {
        setFormData((prev) => ({
            ...
            algorithms: [] // Reset algorithms when category changes
        }));
    };
                            ...
                            <div className="flex flex-col items-center justify-center w-full">
                                ...
                                <div className="card w-full h-fit max-w-270 mt-2 shadow-md mb-6">
                                    <div className="card-body bg-base-100 rounded-xl mx-4 lg:mx-0">
                                        ...
                                        <div className="skeleton h-28 flex flex-col items-start justify-center bg-base-200 rounded-lg px-4 py-2.5">

                                        </div>
                                        <div className="flex flex-col sm:flex-row items-stretch justify-center gap-2 w-full h-full">
                                            <div className="skeleton h-28 flex flex-col items-start justify-start w-full bg-base-200 rounded-lg px-4 py-2.5">

                                            </div>
                                            <div className="skeleton h-28 flex flex-col items-start justify-center w-full bg-base-200 rounded-lg px-4 py-2.5">
                            ...
                            <div className="card w-full h-fit max-w-270 mt-2 shadow-md">
                                <div className="card-body w-full bg-base-100 rounded-xl h-fit mx-4 lg:mx-0">
                                    <div className="flex flex-col items-center justify-between">
                                            <div className="flex flex-col items-center justify-between">
                                                <svg className="mb-2" xmlns="http://www.w3.org/2000/svg" width="35" height="35"
                                                     viewBox="0 0 512 512">
