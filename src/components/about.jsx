            ...
            <div className="container mx-auto px-4 py-8 max-w-7xl">
                ...
                <section className="mb-20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center">
                        {[
                            { name: "Richard De Ocampo Jr.", role: "Full Stack Developer",image: "/badar.jpg"},
                            { name: "Mac Elroy Badar", role: "Project Manager",image: "/badar.jpg"},
                            { name: "Ian Aquino", role: "UI Designer",image: "/aquino.jpg"}
                        ].map((member, index) => (
