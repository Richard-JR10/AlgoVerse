import ChallengesAddData from "./challengesAddData.jsx";
import axios from "axios";
import {useAuth} from "../Auth/AuthContext.jsx";
import {useContext, useEffect, useState} from "react";
import {ErrorContext} from "../context/errorContext.jsx";
import ChallengesAdminTable from "./challengesAdminTable.jsx";
    ...
    return (
        <div className="flex-3 flex-col">
            <div className="flex items-center gap-3 mb-2">
                <h1 className="font-bold text-xl">Challenges Management</h1>
                <ChallengesAddData onAddData={handleAddData}/>
                <button
