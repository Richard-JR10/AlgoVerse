...
import ExampleAddData from "./exampleAddData.jsx";
    ...
    return (
        <div className="flex-3 flex-col">
            <div className="flex items-center gap-3 mb-2">
                <h1 className="font-bold text-xl">Example Management</h1>
