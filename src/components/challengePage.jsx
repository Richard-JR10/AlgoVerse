                    ...
                    <div className="card w-full bg-base-100 shadow-xl">
                        <div className="card-body p-4 sm:p-6">
                            <div className="flex flex-row justify-between items-center">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" className="sm:w-[22px] sm:h-[22px] light:fill-black dark:fill-accent">
                    ...
                    <div className="card w-full bg-base-100 shadow-xl">
                        <div className="card-body p-4 sm:p-6">
                            <div className="flex flex-row justify-between items-center">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 512 512" className="sm:w-[20px] sm:h-[20px] light:fill-black dark:fill-accent">
                    ...
                    <div className="card w-full bg-base-100 shadow-xl">
                        <div className="card-body p-4 sm:p-6">
                            <div className="flex flex-row justify-between items-center">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 24 24" className="sm:w-[21px] sm:h-[21px] light:fill-black dark:fill-accent">
                                    <g fillRule="evenodd">
                                        <path d="m12.594 23.258l-.012.002l-.071.035l-.02.004l-.014-.004l-.071-.036q-.016-.004-.024.006l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427q-.004-.016-.016-.018m.264-.113l-.014.002l-.184.093l-.01.01l-.003.011l.018.43l.005.012l.008.008l.201.092q.019.005.029-.008l.004-.014l-.034-.614q-.005-.019-.02-.022m-.715.002a.02.02 0 0 0-.027.006l-.006.014l-.034.614q.001.018.017.024l.015-.002l.201-.093l.01-.008l.003-.011l.018-.43l-.003-.012l-.01-.01z" />
                                        <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10s10-4.477 10-10S17.523 2 12 2m0 1a9 9 0 0 1-9 9a9 9 0 0 1 9 9a9 9 0 0 1 9-9a9 9 0 0 1-9-9" />
                                    </g>
                                </svg>
                            </div>
